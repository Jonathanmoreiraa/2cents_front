...
const SavingCreateModal: React.FC<SavingCreateModalProps> = ({ open, onClose, onSubmit }) => {
            ...
            isLoadingSimulation ? (
              ...
              <>
                ...
                <Typography mt={1} mb={1} fontSize={14} color="text.secondary">
                  Para alcançar a meta de {formatToMoney(Number(goal))} em {monthsToGoal} {months}, você precisará guardar aproximadamente <b>{formatToMoney(Number(goal) / monthsToGoal)} por mês</b>.
                </Typography>
                <Typography mt={1} mb={1} fontSize={14} color="text.secondary">
                  Caso esse valor não se encaixe no seu orçamento mensal, considere aumentar o número de {months} para atingir a meta. Isso fará com que o valor mensal a ser poupado diminua.
                </Typography>
                <Typography mt={1} mb={1} fontSize={14} color="text.secondary">
