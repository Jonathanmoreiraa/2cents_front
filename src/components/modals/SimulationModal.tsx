            ...
            poupanca > 0 && (
              <>
                  ...
                  <Title>
                    ...
                    >
                      <Typography sx={{ p: 1, fontSize: 12 }}>
                        ...
                        do Banco Central. Para obter uma estimativa mais
                        precisa, recomendamos que você consulte sua instituição
                        financeira.
                      </Typography>
                    </Popover>
                  </Title>
                ...
                <Typography mt={1} mb={1} fontSize={14} color="text.secondary">
                  Investindo <b>{formatToMoney(Number(goal))}</b> por{" "}
                  <b>{monthsToGoal}</b> {months}, seu dinheiro renderá
                  aproximadamente as seguintes quantias no final do período:
                </Typography>
                <Typography mt={1} mb={1} fontSize={14} color="text.secondary">
                  <ul>
                    <li>
